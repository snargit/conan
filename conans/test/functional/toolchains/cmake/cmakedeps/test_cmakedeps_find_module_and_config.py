...
def test_transitive_modules_found(find_mode_PKGA, find_mode_PKGB, find_mode_consumer):
    ...
    cmakelist = textwrap.dedent("""
        ...
        get_target_property(linked_deps pkgb_DEPS_TARGET_RELEASE INTERFACE_LINK_LIBRARIES)
    ...
    assert "MYPKGB_LINKED_LIBRARIES: '$<$<CONFIG:Release>:;>;pkgb_DEPS_TARGET_RELEASE'" in client.out
    assert "MYPKGB_DEPS_LIBRARIES: '$<$<CONFIG:Release>:;pkga::pkga>'" in client.out
