...
class TargetsTemplate(CMakeDepsFileTemplate):
    ...
    def template(self):
        ...
        #    if(NOT $<IN_LIST:${configUpper},allConfigs>)
        #        list(APPEND CMAKE_MAP_IMPORTED_CONFIG_${CMAKE_BUILD_TYPE} ${allConfigs} )
        ...
        #        if(NOT $<IN_LIST:${configUpper},allConfigs>)
        #            list(APPEND CMAKE_MAP_IMPORTED_CONFIG_${configUpper} ${allConfigs} )
        #            list(APPEND CMAKE_MAP_IMPORTED_CONFIG_${configUpper} "")
